...
__pgrep() { __pcheck "${1:-registry}" || __ps aux 2>/dev/null | grep -Fw " ${1:-$registry}" | grep -qv ' grep' || return 10; }
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# export functions
export -f __exec_command __pcheck __pgrep __find __curl __heath_check
export -f __certbot __start_all_services __get_ip4 __get_ip6
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
echo "Executing entrypoint script for registry"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
